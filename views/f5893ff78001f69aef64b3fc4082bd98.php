  ...
  <div class="navbar-container">
    ...
    <div class="navbar-brand-section">
      ...
      <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>">
        <img src="<?php echo e(asset('images/naap-logo.png')); ?>" alt="NAAP Logo" style="height: 40px; width: auto; object-fit: contain;">
    ...
    <div class="navbar-search">
      <form class="search-wrapper" id="navbarSearchForm" method="GET" action="<?php echo e(route('reports.index')); ?>">
    ...
    <div class="navbar-actions">
      ...
      ?>
      <a href="<?php echo e(route('notifications.index')); ?>" class="navbar-icon-btn" title="Notifications">
      ...
      <div class="navbar-user-menu">
        <button class="user-menu-trigger" type="button" id="userMenuTrigger">
          <div class="user-avatar">
            ...
            <?php else: ?>
              <?php echo e(strtoupper(substr($user->email ?? 'U', 0, 1))); ?>

            <?php endif; ?>
          </div>
          <div class="user-info">
            <div class="user-name"><?php echo e($user->profile->full_name ?? 'User'); ?></div>
            <div class="user-role"><?php echo e($isStaff ? 'Staff' : 'Student'); ?></div>
          </div>
        ...
        <div class="user-dropdown" id="userDropdown">
          <div class="dropdown-header">
            <div class="dropdown-user-info">
              <div class="dropdown-user-name"><?php echo e($user->profile->full_name ?? 'User'); ?></div>
              <div class="dropdown-user-email"><?php echo e($user->email); ?></div>
            </div>
          </div>
          ...
          <a href="<?php echo e(route('claims.index')); ?>" class="dropdown-item">
...
<?php /**PATH C:\Users\John Denver\Lost-Found\resources\views/components/layout/navbar.blade.php ENDPATH**/ ?>